...
const Study = (pageProps) => {
  ...
  useEffect(() => {
    ...
    const articleStructuredData = {
      "@context": "https://schema.org", "@type": "FAQPage", "mainEntity":
        [{ "@type": "Question", "name": "How much does it cost to study in USA?", "acceptedAnswer": { "@type": "Answer", "text": "The total cost of studying in Austat level of country are you lookralia varies across courses and universities. The average tuition fees for UG courses is $15,000 to $33,000 (INR 11,15,332- 24,53,731 and PG courses is $20,000 to $37,000 (INR 14,87,150- 27,51,153)" } }, { "@type": "Question", "name": "How do you get PR in USA?", "acceptedAnswer": { "@type": "Answer", "text": "Points determine one’s eligibility for a PR visa. You must score at least 65 points under the Point’s Grid. The categories to achieve points include age, skills, education, experience, language, and sponsorships." } }, { "@type": "Question", "name": "How much does a student earn in USA?", "acceptedAnswer": { "@type": "Answer", "text": "Points determine one’s eligibility for a PR visa. You must score at least 65 points under the Point’s Grid. The categories to achieve points include age, skills, education, experience, language, and sponsorships." } }, { "@type": "Question", "name": "Which is the best course to study in USA?", "acceptedAnswer": { "@type": "Answer", "text": "Being the biggest technology hub, USA is known for courses like Engineering, Data Science, and Electronics. Apart from these, other popular courses include Business Management, Medicine, Architecture, and Accounting." } }, { "@type": "Question", "name": "Which is the best university to study in USA?", "acceptedAnswer": { "@type": "Answer", "text": "The following are the top-ranked universities in USA." } }]
    };
  ...
  return (
    <div>
      <Head>
      <title>Apply USA Study Visa Now - CourseMentor™</title>
        <meta name="description" content="CourseMentor™ - Study Abroad in America - Best University Course Finder to study in usa. Apply for upcoming intakes now!" />
        <meta property="og:title" content="Apply USA Study Visa Now - CourseMentor™" />
        <meta property="og:description" content="CourseMentor™ - Study Abroad in America - Best USA University Course Finder to study in usa. Apply for upcoming intakes now!" />
              ...
              <div className="row  mt-5 mb-5">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-4 mb-3">
                      <div className="study-location-facts_capital__1MYWF">
                        ...
                        <div className="study-location-facts_imgDetails__3qjdN">
                          <p>Currency<br /><strong>USAn Dollar</strong></p>
                        </div>
                      </div>
                    </div>
                    <div className="col-sm-4 mb-3">
                ...
                <div className="col-sm-2">
                  ...
                  <div className="study-location-facts_studyGuide__isgq9 mobile-hide">
                    <div className="textC ">
                      {/* <p style={{ marginBottom: '0px' }}>Download your USA Free Guide</p> */}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="container">
                ...
                <div className="admissionlist">
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <ul>
                        <li><span><FontAwesomeIcon  className="sidebar-faicon" icon={faFile} /></span>USAn secondary school certificate of
                    ...
                    <div className="visa-opt">
                      ...
                      <div className="visaBox blue">
                        ...
                        <p className="desc">This visa is for international students who have recently graduated in
                          USA. It lets you live, study and work in USA temporarily.</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="freedemo">
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <p>A country famed for its pioneering innovations, USA ranks among the top 3 study abroad
                        destinations. Apart from the Group Eight Universities, the island nation houses some of the
                        leading academic institutions offering quality education across fields. USA is the
                      ...
                      <p>Studying in USA guarantees high academic standards and globally recognised
                        qualifications with education administered by the USAn Qualifications Framework (AQF).
                        From experiencing a serene environment and exploring the world’s largest coral reef,
                        studying in USA is definitely a unique experience.</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header" id="headingThree">
                          <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            How much does a student earn in USA?
                          </button>
                        </h2>
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header" id="headingFour">
                          <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour"
                            ...
                            Which is the best course to study in USA?
                          </button>
                        </h2>
                        <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour"
                          data-bs-parent="#accordionExample">
                          <div className="accordion-body">
                            <strong>Being the biggest technology hub, USA is known for courses like Engineering, Data Science, and Electronics. Apart from these, other popular courses include Business Management, Medicine, Architecture, and Accounting.</strong>
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item">
                        <h2 className="accordion-header" id="headingFive">
                          <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive"
                            ...
                            Which is the best university to study in USA?
                          </button>
                        </h2>
                        <div id="collapseFive" className="accordion-collapse collapse" aria-labelledby="headingFive"
                          data-bs-parent="#accordiFivexample">
                          <div className="accordion-body">
                            <strong> The following are the top-ranked universities in USA.</strong>
                          </div>
                        </div>
                      </div>
                    </div>
