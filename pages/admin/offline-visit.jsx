...
export default function Counseling() {
    ...
    const [comments, setComments] = useState([{
        name: "", email: "", phone: "", buildStudentID: "", _id: "", agentName: "",purpose:""
    }])
    ...
    const tableHeaders = [
        ...
        { name: "Offline Visit Id", field: "buildOfflineVisitId", sortable: true },
    ...
    function myallStudents() {
        setmyloader("true")
        const url = process.env.REACT_APP_SERVER_URL + "admin/allOfflineVisit";
        fetch(url, {
            method: 'GET',
                                                    ...
                                                    <tbody>
                                                        {commentsData.map((object, i) => {
                                                            return (
                                                                <tr key={i}>
                                                                    <td>{object.NO}</td>
                                                                    <td>{object.buildOfflineVisitId}</td>
