...
export default function AdminStudentApplication() {
    ...
    useEffect(() => {
        ...
        if (adminId !== null) {
            ...
            //         _id: "null"
            //     }])
            //     setstudentPassportDocument("")
            //     setstudentPassportBackDocument("")
            //     setstudentCVDocument("")
            //     setstudentmarksheet10Document("")
            //     setstudentmarksheet12Document("")
            //     setstudentugDegreeDocument("")
            //     setstudentugConsolidateDocument("")
            //     setstudentugMarksheetDocument("")
            //     setstudentpgDegreeDocument("")
            //     setstudentpgDegreeConsolidatedDocument("")
            //     setstudentpgMarksheetDocument("")
            //     setstudentExperienceDocument("")
            //     setstudentEnglishProficiencyDocument("")
            //     setstudentExtraCurricularDocument("")
            //     setstudentRecommendationDocument("")
            //     setstudentOtherDocument("")
            //     //end 
            //     setid(id)
            //     setstudentOtherDocument("")
            //     setstudentRecommendationDocument("")
            ...
            //     var url80 = process.env.REACT_APP_SERVER_URL + 'admin/oneOrder/' + state1;
            ...
            //                     });
            //                 if (mystudentID !== "") {
            //                     axios.get(process.env.REACT_APP_SERVER_URL + 'admin/msg/' + mystudentID + "/" + state1, { headers: { 'Authorization': mounted } })
            //                         .then(function (res) {
            //                             if (res.data.success === true) {
            ...
            //     };
            //     axios.put(process.env.REACT_APP_SERVER_URL + 'admin/orderView/' + state1, obj2, { headers: { 'Authorization': mounted } })
            //         .then(function (res) {
            //             setmyloader("false")
            //             if (res.data.success === true) {
    ...
    //             axios.put(process.env.REACT_APP_SERVER_URL + 'admin/messagesUnread/' + state1, obj1, { headers: { 'Authorization': mounted } })
    //                 .then(function (res) {
