...
export default function Counseling() {
    ...
    function myallStudents() {
        setmyloader("true")
        const url = process.env.REACT_APP_SERVER_URL + "admin/allcounselor/";
        fetch(url, {
            method: 'GET',
        ...
        <div className="container-fluid">
            ...
            {showSweetAlert === "1" ? <SweetAlert
                ...
                onConfirm={(value) => {
                    setshowSweetAlert("0");
                    setmyloader("true")
                    axios.delete(process.env.REACT_APP_SERVER_URL + 'admin/allcounselor/' + deleteId, { headers: { 'Authorization': mounted } })
                        .then(function (res) {
                            setmyloader("false")
