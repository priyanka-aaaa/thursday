            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6">
                <div className="banner-content">
                  <h1 className="title"><span>Your Success is Our Success –</span><br /> We’re Here to See
                    You Grow</h1>
                  <p className="desc">
                    CourseMentorTM is more than a platform, it is your trusted partner to help you do what you do best: help as many students as possible fulfill their international education dreams.
                  </p>
                    ...
                    <div className="front-part">
                      <div className="front-content-part purple-bg">
                        ...
                        <div className="front-desc-part">
                          <p>
                            Quick and reliable commissions
                            so you get paid for your
                            hard work.</p>
                        </div>
              ...
              <div className="col-lg-6 md-mb-50">
                <div className="sec-title mb-30">
                  ...
                  <h2 className="title pb-20">
                    Join 10,000+ Global Recruitment Partners
                  </h2>
                  <div className="desc">
                    <ul>
