...
export async function getServerSideProps(context) {
  const res = await axios.get(process.env.REACT_APP_SERVER_URL + 'universityCountry/United Kingdom')
  return {
    props: {
  ...
  useEffect(() => {
    ...
    const articleStructuredData = {
      "@context": "https://schema.org", "@type": "FAQPage", "mainEntity":
        [{ "@type": "Question", "name": "How much does it cost to study in UK?", "acceptedAnswer": { "@type": "Answer", "text": "The total cost of studying in Austat level of country are you lookralia varies across courses and universities. The average tuition fees for UG courses is $15,000 to $33,000 (INR 11,15,332- 24,53,731 and PG courses is $20,000 to $37,000 (INR 14,87,150- 27,51,153)" } }, { "@type": "Question", "name": "How do you get PR in UK?", "acceptedAnswer": { "@type": "Answer", "text": "Points determine one’s eligibility for a PR visa. You must score at least 65 points under the Point’s Grid. The categories to achieve points include age, skills, education, experience, language, and sponsorships." } }, { "@type": "Question", "name": "How much does a student earn in UK?", "acceptedAnswer": { "@type": "Answer", "text": "Points determine one’s eligibility for a PR visa. You must score at least 65 points under the Point’s Grid. The categories to achieve points include age, skills, education, experience, language, and sponsorships." } }, { "@type": "Question", "name": "Which is the best course to study in UK?", "acceptedAnswer": { "@type": "Answer", "text": "Being the biggest technology hub, UK is known for courses like Engineering, Data Science, and Electronics. Apart from these, other popular courses include Business Management, Medicine, Architecture, and Accounting." } }, { "@type": "Question", "name": "Which is the best university to study in UK?", "acceptedAnswer": { "@type": "Answer", "text": "The following are the top-ranked universities in UK." } }]
    };
              ...
              <div className="row  mt-5 mb-5">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-4 mb-3">
                      <div className="study-location-facts_capital__1MYWF">
                        ...
                        <div className="study-location-facts_imgDetails__3qjdN">
                          <p>Currency<br /><strong>UKn Dollar</strong></p>
                        </div>
                      </div>
                    </div>
                    <div className="col-sm-4 mb-3">
                ...
                <div className="col-sm-2">
                  ...
                  <div className="study-location-facts_studyGuide__isgq9 mobile-hide">
                    <div className="textC ">
                      {/* <p style={{ marginBottom: '0px' }}>Download your UK Free Guide</p> */}
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div className="visa-opt">
                      ...
                      <div className="visaBox blue">
                        ...
                        <p className="desc">This visa is for international students who have recently graduated in
                          UK. It lets you live, study and work in UK temporarily.</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="freedemo">
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <p>A country famed for its pioneering innovations, UK ranks among the top 3 study abroad
                        destinations. Apart from the Group Eight Universities, the island nation houses some of the
                        leading academic institutions offering quality education across fields. UK is the
                      ...
                      <p>Studying in UK guarantees high academic standards and globally recognised
                        qualifications with education administered by the UKn Qualifications Framework (AQF).
                        From experiencing a serene environment and exploring the world’s largest coral reef,
                        studying in UK is definitely a unique experience.</p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div className="accordion" id="accordionExample">
                      ...
                      <div className="accordion-item">
                        ...
                        <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour"
                          data-bs-parent="#accordionExample">
                          <div className="accordion-body">
                            <strong>Being the biggest technology hub, UK is known for courses like Engineering, Data Science, and Electronics. Apart from these, other popular courses include Business Management, Medicine, Architecture, and Accounting.</strong>
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item">
                        <h2 className="accordion-header" id="headingFive">
                          <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive"
                            ...
                            Which is the best university to study in UK?
                          </button>
                        </h2>
