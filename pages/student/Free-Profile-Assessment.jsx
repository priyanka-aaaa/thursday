      ...
      axios.post(myurl + 'student/login', obj)
        .then(result => {
          ...
          if (responseJson.data.success === true) {
            ...
            window.location.href = "/student/search-courses"
                          ...
                          <div className="eval-flag-tab" style={{ display: countryFilter }}>
                            <div className="evaluation-form-container" >
                              ...
                              <div className="eval-count-list">
                                <ul>
                                  <li>
                                    <div className={flagUSA} onClick={() => handleCountryClick("United States")}>
                                  ...
                                  <li>
                                    <div className={flagUK} onClick={() => handleCountryClick("United Kingdom")}><img
                                  ...
                                  <li>
                                    <div className={flagAustralia} onClick={() => handleCountryClick("Australia")}><img
                                  ...
                                  <li>
                                    <div className={flagNewZealand} onClick={() => handleCountryClick("NewZealand")}><img
                                      src="/images/new-zea-flag.jpg"
                                  ...
                                  <li>
                                    <div className={flagCanada} onClick={() => handleCountryClick("Canada")}><img
                                  ...
                                  <li>
                                    <div className={flagGermany} onClick={() => handleCountryClick("Germany")}><img
                                      src="/images/ire-flag.jpg"
