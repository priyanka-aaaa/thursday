        ...
        function DocumentAll() {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    var workData = completeResult.filter((item) => item.documentName === "Extra Curricular");
                                                        ...
                                                        <div className="col-3 col-sm-3 col-md-3 col-lg-3">
                                                            <div className="from-group">
                                                                ...
                                                                <input className="ant-input w-100 form-control"
                                                                    ...
                                                                    name="name"
                                                                    placeholder="Enter Activity Name" type="text"
                                                                />
                                                            </div>
                                                        </div>
                                                            ...
                                                            {element.documentName !== "" &&
                                                                ...
                                                                {element.fileExtension === "docx" || element.fileExtension === "doc" ?
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        title="view document" type="button" className="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target={"#myModalExtraCurricular" + index} >
                                                                        View
                                                                    </a>
                                                                }
                                                                ...
                                                                <div className="modal" id={"myModalExtraCurricular" + index} >
                                                                ...
                                                                : <Dropzone onDrop={(acceptedFiles) => {
                                                                    ...
                                                                    if (fileExtension === "pdf" || fileExtension === "doc" || fileExtension === "docx"
                                                                        ...
                                                                        if (element.name !== "" && element.name !== undefined) {
                                                                            ...
                                                                            obj5.append("documentName", "Extra Curricular");
