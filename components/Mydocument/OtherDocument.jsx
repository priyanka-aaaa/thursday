        ...
        function DocumentAll() {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    var workData = completeResult.filter((item) => item.documentName === "Other");
                        ...
                        {toogleValues == "true" ?
                            ...
                            : <div className="row pl-4 pr-4 mt-3">
                                <div className="col-md-8">
                                    {toogleValues === "false" ?
                                        <p>I don't have any Other Document</p>
                                        : null
                                    }
                                </div>
                                                            ...
                                                            {element.documentName !== "" &&
                                                                ...
                                                                {element.fileExtension === "docx" || element.fileExtension === "doc" ?
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        title="view document" type="button" className="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target={"#myModalother" + index} >
                                                                        View
                                                                    </a>
                                                                }
                                                                ...
                                                                <div className="modal" id={"myModalother" + index} >
                                                                ...
                                                                : <Dropzone onDrop={(acceptedFiles) => {
                                                                    ...
                                                                    if (fileExtension === "pdf" || fileExtension === "doc" || fileExtension === "docx"
                                                                        ...
                                                                        if (element.name !== "" && element.name !== undefined) {
                                                                            ...
                                                                            obj5.append("documentName", "Other");
