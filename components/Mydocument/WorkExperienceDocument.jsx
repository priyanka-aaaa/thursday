        ...
        function DocumentAll() {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    var workData = completeResult.filter((item) => item.documentName === "Work Experience");
                                                        ...
                                                        <div className="col-3 col-sm-3 col-md-3 col-lg-3 text-left">
                                                            ...
                                                            {element.documentName !== "" &&
                                                                ...
                                                                {element.fileExtension === "docx" || element.fileExtension === "doc" ?
                                                                    ...
                                                                    :
                                                                    <a title="view document" type="button" className="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target={"#myModalworkExperience" + index} >
                                                                        View
                                                                    </a>
                                                                }
                                                                ...
                                                                <div className="modal" id={"myModalworkExperience" + index} >
                                                                ...
                                                                : <Dropzone onDrop={(acceptedFiles) => {
                                                                    ...
                                                                    if (fileExtension === "pdf" || fileExtension === "doc" || fileExtension === "docx"
                                                                        ...
                                                                        if (element.name !== "" && element.name !== undefined) {
                                                                            ...
                                                                            obj5.append("documentName", "Work Experience");
