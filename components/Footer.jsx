      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-3 col-md-6">
            <div className="footer-logo mb-30">
              <a href="https://coursementor.com/">
                < Image unoptimized={true} layout="fill" src="/logo-white.webp" alt="" loading="lazy"  /></a>
            </div>
          ...
          <div className="col-xl-3 col-md-12">
            ...
            <a href='https://www.iwinvisa.com/'>< Image unoptimized={true} layout="fill" src="/i-win.webp" alt="" loading="lazy" /></a>
          </div>
